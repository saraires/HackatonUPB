                ...
                <div id="tags" className="container">
                    ...
                    <form className="row" onSubmit={handleSubmit(llenarTags)}>
                        ...
                        <div className='tags'>
                            ...
                            <input type="checkbox" value="relajacion" className="btn-check" name="tag2" id="relajacion" autocomplete="off" />
                            <label className="btn btn-outline-success" for="relajacion">Actividades de relajación  <img src="https://cdn.pixabay.com/photo/2015/02/09/20/03/koala-630117__340.jpg" height="50px" width="50px" /></label>
                            <br />
                        </div>
