          ...
          <div className="row justify-content-center">
            <div>
              <input
                ...
                {...register("categorias")}
              />
              <label class="btn btn-outline-success m-5" for="hospedajes">
                Hospedajes{" "}
                <img
                  src="https://cdn.pixabay.com/photo/2015/02/09/20/03/koala-630117__340.jpg"
                  height="50px"
                  width="50px"
                />
              </label>
              ...
              <input
                ...
                {...register("categorias")}
              />
              <label class="btn btn-outline-success" for="experiencias">
        ...
        <div className="row justify-content-center">
          <form className="row" onSubmit={handleSubmit(onSubmitTag)}>
            ...
            <div className="tags">
              ...
              <label class="btn btn-outline-success" for="deporte">
              ...
              <input
                ...
                autocomplete="off"
              />
              <label class="btn btn-outline-success" for="relajacion">
